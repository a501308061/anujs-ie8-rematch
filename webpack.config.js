...
module.exports = {
    ...
    resolve: {
        ...
        extensions: ['', '.js', '.jsx'],
        alias: {
            'react': path.resolve('./lib/anujs_all.js'),
            'react-dom': path.resolve('./lib/anujs_all.js'),
            'devtools' : "anujs/lib/devtools",
            'IntlComponent':path.resolve('./src/i18n/IntlComponent')
        }
    },
    module: {
        loaders: [
            ...
            {test: /\.scss$/,loader: ExtractTextPlugin.extract("style", "css?modules=false&sourceMap=true!postcss!sass", {publicPath: "./"})},
